...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class CPSubsystemRemoveGroupAvailabilityListenerServerCodec
#else
    internal static class CPSubsystemRemoveGroupAvailabilityListenerCodec
#endif
    {
        public const int RequestMessageType = 2229248; // 0x220400
        public const int ResponseMessageType = 2229249; // 0x220401
        ...
        public static ClientMessage EncodeRequest(Guid registrationId)
        {
            ...
            {
                IsRetryable = true,
                OperationName = "CPSubsystem.RemoveGroupAvailabilityListener"
            };
