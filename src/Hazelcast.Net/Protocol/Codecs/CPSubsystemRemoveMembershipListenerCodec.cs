...
namespace Hazelcast.Protocol.Codecs
{
    ...
    ///</summary>
#if SERVER_CODEC
    internal static class CPSubsystemRemoveMembershipListenerServerCodec
#else
    internal static class CPSubsystemRemoveMembershipListenerCodec
#endif
    {
        public const int RequestMessageType = 2228736; // 0x220200
        public const int ResponseMessageType = 2228737; // 0x220201
        ...
        public static ClientMessage EncodeRequest(Guid registrationId)
        {
            ...
            {
                IsRetryable = true,
                OperationName = "CPSubsystem.RemoveMembershipListener"
            };
